...
f_2= imresize(imrotate(imread('C:\Users\Wil Boshell\mcm2019\Rendering\assets\_2.jpg'),-90),0.5); %f_2.
...
while 1
    ...
    A=polyarea(x,y);
    M_2(nid,1:15)=[nid,xc,yc,z,t,dw,A,x',y'];
    nid=nid+1;
end
csvwrite('nodes_2.csv',M_2)